...
public class chaincode_example02 extends ChaincodeBase {

    private static Log log = LogFactory.getLog(chaincode_example02.class);
    ...
    public static void main(String[] args) throws Exception {
        new chaincode_example02().start(args);
    }
}
